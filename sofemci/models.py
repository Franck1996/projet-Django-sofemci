...
class Machine(models.Model):
    ...
    prochaine_maintenance_prevue = models.DateField(null=True, blank=True, verbose_name="Prochaine maintenance prévue")
    frequence_maintenance_jours = models.IntegerField(default=90, verbose_name="Fréquence maintenance (jours)")
    
    nombre_pannes_totales = models.IntegerField(default=0, verbose_name="Nombre de pannes totales")
    nombre_pannes_6_derniers_mois = models.IntegerField(default=0, verbose_name="Pannes - 6 derniers mois")
    nombre_pannes_1_dernier_mois = models.IntegerField(default=0, verbose_name="Pannes - dernier mois")
    date_derniere_panne = models.DateTimeField(null=True, blank=True, verbose_name="Date dernière panne")
    duree_moyenne_reparation = models.DecimalField(max_digits=6, decimal_places=2, default=0, verbose_name="Durée moyenne réparation (heures)")
    
    consommation_electrique_kwh = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name="Consommation électrique actuelle (kWh)")
    consommation_electrique_nominale = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name="Consommation nominale (kWh)")
    
    temperature_actuelle = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Température actuelle (°C)")
    temperature_nominale = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name="Température nominale (°C)")
    temperature_max_autorisee = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name="Température max autorisée (°C)")
    
    score_sante_global = models.DecimalField(max_digits=5, decimal_places=2, default=100, verbose_name="Score santé global (%)")
    probabilite_panne_7_jours = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name="Probabilité panne 7 jours (%)")
    probabilite_panne_30_jours = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name="Probabilité panne 30 jours (%)")
    
    anomalie_detectee = models.BooleanField(default=False, verbose_name="Anomalie détectée")
    type_anomalie = models.CharField(max_length=100, blank=True, verbose_name="Type d'anomalie")
    date_derniere_analyse_ia = models.DateTimeField(null=True, blank=True, verbose_name="Dernière analyse IA")
    
    derniere_mise_a_jour_donnees = models.DateTimeField(auto_now=True, verbose_name="Dernière mise à jour données")
